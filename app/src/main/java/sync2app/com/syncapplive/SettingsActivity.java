...
*/
    ...
    public static class SettingsFragment extends PreferenceFragmentCompat {
        ...
        public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
            ...
            SwitchPreference HideToolbar = findPreference("HideToolbar");
            ...
            String get_HideToolbar = sharedBiometric.getString(Constants.HIDE_TOOLBAR, "");
           ...
           if (get_HideToolbar.equals(Constants.HIDE_TOOLBAR)){
               HideToolbar.setTitle("Hide Toolbar");
            }else {
               HideToolbar.setTitle("Show Toolbar");
            }
            ...
            } else  if (get_AppMode.equals(Constants.TV_Mode)) {
            ...
            if (HideToolbar != null) {
                HideToolbar.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                    @RequiresApi(api = Build.VERSION_CODES.TIRAMISU)
                    @Override
                    public boolean onPreferenceChange(Preference arg0, Object isChanged) {
                        boolean isItemOn = (Boolean) isChanged;
                        if (isItemOn) {
                            HideToolbar.setTitle("Hide Toolbar");
                            editor.putString(Constants.HIDE_TOOLBAR, Constants.HIDE_TOOLBAR);
                            editor.apply();

                        } else {
                            HideToolbar.setTitle("Show Toolbar");
                            editor.remove(Constants.HIDE_TOOLBAR);
                            editor.apply();
                        }
                        return true;
                    }
